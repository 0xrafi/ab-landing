    ...
    return (
        <>
            ...
            <div className="TextContent">
                ...
                Our wedding will be the first experience of its kind, turning our cherished moments into 
                infinitely collectible and timeless tradeable tokens on the Ethereum blockchain.
                <h2>#abinfinity</h2>
            </div>
        </>
    );
